...
(function () {
  ...
  const captions = [
    ...
    { lugar: 'Barrio Tercero',   desc: 'Calles y vida cotidiana'          },
    { lugar: 'Puente Peatonal',  desc: 'Cosoleacaque, Veracruz'           },
    { lugar: 'Mercado Regional', desc: 'Productos del sur veracruzano'    },
    { lugar: 'Gente del Sur',    desc: 'Identidad y tradición jarocha'    },
  ];
